...
const bn = createLocaleWithFallback({}, {
  brand: { name: "আরোগ্য টাইমলাইন", tagline: "আপনার ব্যক্তিগত স্বাস্থ্য স্মৃতি" },
...
const ta = createLocaleWithFallback({}, {
  brand: { name: "ஆரோக்ய டைம்லைன்", tagline: "உங்கள் தனிப்பட்ட சுகாதார நினைவகம்" },
...
const te = createLocaleWithFallback({}, {
  brand: { name: "ఆరోగ్య టైమ్‌లైన్", tagline: "మీ వ్యక్తిగత ఆరోగ్య జ్ఞాపకం" },
...
const kn = createLocaleWithFallback({}, {
  brand: { name: "ಆರೋಗ್ಯ ಟೈಮ್‌ಲೈನ್", tagline: "ನಿಮ್ಮ ವೈಯಕ್ತಿಕ ಆರೋಗ್ಯ ಸ್ಮೃತಿ" },
...
const ml = createLocaleWithFallback({}, {
  brand: { name: "ആരോഗ്യ ടൈംലൈൻ", tagline: "നിങ്ങളുടെ സ്വകാര്യ ആരോഗ്യ സ്മരണ" },
...
const gu = createLocaleWithFallback({}, {
  brand: { name: "આરોગ્ય ટાઈમલાઈન", tagline: "તમારી વ્યક્તિગત સ્વાસ્થ્ય સ્મૃતિ" },
...
const pa = createLocaleWithFallback({}, {
  brand: { name: "ਅਰੋਗਿਆ ਟਾਈਮਲਾਈਨ", tagline: "ਤੁਹਾਡੀ ਨਿੱਜੀ ਸਿਹਤ ਯਾਦ" },
