          ...
          >
            <div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-100 space-y-2 text-xs text-slate-600">
                ...
                {doc.nextAppointment && (
                  <div className="p-2.5 rounded-xl bg-cyan-50 border border-cyan-100 text-cyan-900 font-bold flex items-center justify-between">
                    <span>Next Appointment:</span>
                    <span>{doc.nextAppointment}</span>
                  </div>
                )}
              </div>
            </div>
